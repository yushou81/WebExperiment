        ...
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4 enableGroupContainer">
                    <div class="input-group">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
                        <input type="checkbox" name="listOption" class="form-control" value="1" checked="checked"/>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4 enableGroupContainer">
                    <div class="input-group">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
                        <input type="checkbox" name="bannerOption" class="form-control" value="1" checked="checked"/>
                    </div>
                </div>
            </div>
