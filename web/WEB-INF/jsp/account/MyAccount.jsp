    ...
    <fieldset>
      ...
      <div class="form-group">
        ...
        <div class="col-md-4 inputGroupContainer">
          <div class="input-group">
            ...
            <input  name="userName" placeholder="UserName" class="form-control" value="${sessionScope.account.username}" type="text">
          </div>
        </div>
      </div>
      <!-- Text input-->
      ...
      <div class="form-group">
        ...
        <div class="col-md-4 inputGroupContainer">
          <div class="input-group">
            <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
            <input  name="repeatPassword" placeholder="Confirm Password" class="form-control"  type="text">
          </div>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-md-4 enableGroupContainer">
          <div class="input-group">
            <span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
            <input type="checkbox" name="listOption" class="form-control" value="1" ${sessionScope.account.listOption == '1' ? 'checked' : ''}/>
          </div>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-md-4 enableGroupContainer">
          <div class="input-group">
            <span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
            <input type="checkbox" name="bannerOption" class="form-control" value="1" ${sessionScope.account.bannerOption == '1' ? 'checked' : ''}/>
          </div>
        </div>
      </div>
